...
// Team Variant A — Baseline. Two founder cards with orange-wipe-up hover.
// Identical structure to v2 TeamV2 component — included as the reference
// control for the iteration set.
      ...
      <div className="flex h-auto w-full max-w-[1500px] flex-col gap-5 pt-[60px]">
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 z-10 flex h-1/5 items-center justify-between px-5">
                <div className="h-full w-1/2">
                  ...
                  <p className="m-0 text-left font-mono text-[16px] leading-[20px] text-black transition-colors duration-300 group-hover:text-white">
                    {member.role}
                  </p>
                </div>
                <Link
        ...
        >
          <div className="flex w-1/2 max-lg:w-full">
            <p className="m-0 text-left font-mono text-[20px] leading-[24px] text-black max-lg:text-[16px] max-lg:leading-[20px]">
              {TEAM.body}
            </p>
          </div>
